...
<body class="d-flex align-items-center">
    ...
    <div id="sample-text-card" class="card col-6 bg-transparent border-0">
        ...
        <div class="card-body">
            <!-- Card Header -->
           <h1 class="mb-3">Home-Savyy App</h1>
           <!-- End Card Header -->

           <!-- Card Title -->
           <h5 class="card-title">
                Welcome to Home Savvy!
           </h5>
           <!-- End Of Card Title -->

           <!-- Card Text -->
           <p class="card-text">
            Our goal is to help you manage your home finances in a smart and efficient way. 
            With Home Savvy, you can easily track your expenses and plan ahead to reach your financial goals.
           </p>
           <!-- End Of Card Text -->
